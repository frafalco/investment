...
export const upsertStrategy = createAction('[Profile] Add Strategy', props<{ id: number | null, name: string | null, starting_bankroll: number | null, str_type: string | null, archived: boolean | null }>());
